...
loc_axis <- -730 # decrease to move the axis towards the bottom; increase to move towards the top (is usually negative but can take on both positive and negative values)
...
axis(side = 1, at = labels_at_2, labels = ins_ticks, 
     tick = TRUE, pos = c(loc_axis, 0))
axis(side = 1, at = labels_at, labels = FALSE, 
     tcl = -0.25, pos = c(loc_axis, 0))
